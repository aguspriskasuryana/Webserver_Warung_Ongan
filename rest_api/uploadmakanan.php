...
$target_dir = "../images/makanan/";
$id_makanan = $_POST["id_makanan_image"];
//var_dump($id_makanan);
$image = $_POST["image"];
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["berkas"]["tmp_name"], ($target_dir.$id_makanan.".".$ext)  )) {
        
        $response = $makananObject->updateImageMakanan($id_makanan,$id_makanan.".".$ext);
