...
switch ($command) {
	case $commandObject->CMD_SAVE:
			...
			$jsonsave = $makananObject->createMakanan($makananid,$makananname,$makanandetail,$makananharga,$makananstatus,$makananimg);
	...
	case $commandObject->CMD_UPDATE:
			...
			$jsonsave = $makananObject->updateMakanan($makananid, $makananname, $makanandetail,$makananharga,$makananstatus, $makananimg);
